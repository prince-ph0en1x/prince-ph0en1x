...
Most of my current GitHub activities are hosted under the [Quantum Intelligence Alliance](https://github.com/Advanced-Research-Centre) and FRIPL organization. Past projects and collaborations can be accessed at [Quantum Machine Learning](https://github.com/QML-Group) and [Quantum Computer Architecture Lab](https://github.com/QE-Lab).
